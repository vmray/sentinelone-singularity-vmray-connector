...
class VMRay:
    ...
    def healthcheck(self):
        ...
        try:
            ...
            self.log.info("VMRay Healthcheck is successful.")
            return True
    ...
    def get_sample(self, identifier, sample_id=False):
        """
        Retrieve sample summary from VMRay database with sample_id or sha1 hash value
        :param identifier: sample_id or sha1 hash value to identify submitted sample
        :param sample_id: boolean value to determine which value (sample_id or sha1) is passed to function
        ...
        if sample_id:
            ...
            url = "/rest/sample/sha1/" + identifier
    ...
    def submit_samples(self, evidences):
        ...
        :param evidences: list of evidences which downloaded from SentinelOne
    ...
    def wait_submissions(self, submissions):
        ...
        :return custom_dict : contains submission status, submission information and API response
        """

        method = "GET"
        url = "/rest/submission/%s"

        # Creating submission_objects list with submission information
        ...
        while len(submission_objects) > 0:
            ...
            for submission_object in submission_objects:
                try:
                    ...
                    # If submission is finished, return submission information and process sample report,IOC etc
